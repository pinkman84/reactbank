...
/***/ function(module, exports, __webpack_require__) {
	...
	var BankBox = React.createClass({
	  ...
	  totalMoney: function totalMoney(accounts) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        ' Total in Bank: £',
	        this.totalMoney(this.state.accounts)
	      ),
	      React.createElement(
	        'div',
	        { className: 'personal' },
	        React.createElement(AccountBox, { accounts: this.filteredAccounts('Personal'), totals: this.totalMoney(this.filteredAccounts('Personal')) })
	      ),
	      React.createElement(
	        'div',
	        { className: 'business' },
	        React.createElement(AccountBox, { accounts: this.filteredAccounts('Business'), totals: this.totalMoney(this.filteredAccounts('Business')) })
	      ),
	      React.createElement(
	        'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AccountInfo = __webpack_require__(162);
